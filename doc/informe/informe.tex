...
\section{Conclusion}
    ...
    % The presented model was able to reproduce different number of pedestrians
    % leaving a room with different door sizes and showing that the exit flow
    % dos not depend on the number of pedestrians (in contrast to the SFM model)
\newpage{}
